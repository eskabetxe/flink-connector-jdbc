...
import org.apache.flink.connector.jdbc.oracle.testutils.OracleDatabase;
...
/** Oracle catalog test base. */
public class OracleCatalogTestBase extends OracleDatabase {
    ...
    static void init() throws SQLException {
        ...
        createTable(
                TEST_DB,
                new PostgresTablePath(TEST_SCHEMA, TABLE3),
                getSimpleTable().oracleSchemaSql);
        createTable(
